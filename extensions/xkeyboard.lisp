...
(defpackage #:xlib/xkb
  ...
  (:export :enable-xkeyboard
   ...
   :make-device-state :device-state-p
   :copy-device-state :device-state-device-id
   :device-state-mods :device-state-base-mods
   :device-state-latched-mods :device-state-locked-mods
   :device-state-group :device-state-locked-group
   :device-state-base-group :device-state-latched-group
   :device-state-compat-state :device-state-grab-mods
   :device-state-compat-grab-mods :device-state-lookup-mods
...
(eval-when (:load-toplevel :execute)
  (defparameter +xkb-table+ (make-hash-table)))

(eval-when (:load-toplevel :execute)
  (mapcar 
   (lambda (x)
     (let ((keysym (cadr (assoc :keysym x))))
       (setf (gethash keysym +xkb-table+) x)))
