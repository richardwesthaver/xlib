...
(define-constant* +predefined-atoms+
...
(define-constant* +bit-gravity-vector+
...
(define-constant* +win-gravity-vector+
...
(define-constant* +event-mask-vector+
...
(define-constant* +pointer-event-mask-vector+
...
(define-constant* +device-event-mask-vector+
...
(define-constant* +state-mask-vector+
...
(define-constant* +gcontext-components+
